            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <a href="/view/course_detail.php?id=<?php echo $course['id'] ?>"
                            class="text-decoration-none text-dark py-1 px-3 fw-bold rounded-2"
                            style="background-color: orange !important;">Daftar Sekarang</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>

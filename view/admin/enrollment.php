...
// Ambil semua data pendaftaran (join ke users dan courses)
...
<head>
  ...
  <title>Konfirmasi Pendaftaran | Adzkia Admin</title>
  ...
  <div>
    <div class="brand">Adzkia Admin</div>
     <nav class="nav flex-column px-2">
      ...
      <a href="enrollment.php" class="nav-link active"><i class="bi bi-card-checklist me-2"></i>Enrollment</a>
...
<main>
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold text-primary">Konfirmasi Pendaftaran</h3>
  </div>
            ...
            <tr>
              ...
              <td>
                <?php if($e['status'] == 'menunggu konfirmasi' || $e['status'] == 'pending'){ ?>
                  <a href="enrollment.php?id=<?= $e['enroll_id'] ?>&action=confirm" class="btn btn-success btn-sm"><i class="bi bi-check-circle"></i></a>
                  <a href="enrollment.php?id=<?= $e['enroll_id'] ?>&action=reject" class="btn btn-danger btn-sm"><i class="bi bi-x-circle"></i></a>
                <?php } else { ?>
